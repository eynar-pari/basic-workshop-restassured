...
public class BasicRestAssuredSchema {
    /*
    *  given ---> configuration
    *  when ---> method
    *  then ---> responses
    * */
    @Test
    public void verifyCRUDProjectSchema(){
        ...
        response.then()
                ...
                .body("Icon",equalTo(1))
                .body(matchesJsonSchemaInClasspath("project-expected-schema.json").using(jsonSchemaFactory))
                .log().all();
    }
}
